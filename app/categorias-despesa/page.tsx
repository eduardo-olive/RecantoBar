  ...
  return (
    <div className="space-y-5 pb-8">
      <header className="border-l-4 border-rose-500 pl-4 py-1">
        <h1 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic">Categorias de Despesa</h1>
        <p className="text-slate-500 font-bold text-xs uppercase tracking-widest mt-0.5">Gerencie as categorias usadas nas despesas operacionais</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {categorias.length === 0 ? (
          ...
          categorias.map((cat) => (
            <div key={cat.id} className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-between group hover:border-rose-500 transition-all">
